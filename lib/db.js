...
module.exports = {
    ...
    and: 'select * from person as a left join card as b on a.cardNo = b.cardNo',
    count: 'select COUNT(*) as count from person as a left join card as b on a.cardNo = b.cardNo',
